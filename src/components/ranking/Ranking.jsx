...
const Ranking = () => {
  ...
  return (
    <main className="ml-5 mr-5 top-0 min-h-[calc(100vh_-_182px)]">
      <div className="flex flex-col pb-4 pt-[75px] xl:pt-[98px]">
        {/* Background Gradient */}
        <div className="absolute top-0 left-0 z-0 w-screen h-[60vw] sm:h-[43vw] md:h-[33vw] "></div>
        ...
        <div className="relative flex flex-col gap-4 lg:gap-6 mb-8 lg:mb-10">
          ...
          <div className="flex lg:justify-between">
            ...
            <div className="relative flex flex-wrap lg:flex-nowrap space-x-2 lg:space-x-4 h-10 border border-base dark:border-[#55496E] rounded-full shadow-md">

              {/* Button 1: Progress Ranking */}
              <button
                type="button"
                className="flex-1 flex items-center justify-center h-10 px-4 text-center font-medium text-[#7A6EAA] dark:text-purple-500 rounded-full hover:bg-purple-300 overflow-hidden whitespace-nowrap text-ellipsis"
            ...
            <div className="mt-4 mr-5 lg:mt-0">
              <Link
                to="/"
                className="inline-block px-6 py-3 text-white bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 rounded-full text-center shadow-lg transition-all duration-200 ease-in-out"
              >
                Create Token
              </Link>
            </div>
